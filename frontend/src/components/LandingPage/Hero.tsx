  ...
  return (
    <div className="px-8 sm:px-30">
        <div className="text-black">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 px-1 sm:px-4 py-4">
        ...
        <div className="text-center mt-20">
            ...
            <SignInButton>
              <div className="bg-blue-500 w-30 m-auto text-white py-3 px-3 text-xs rounded-xl hover:bg-blue-700 transition-all duration-200 cursor-pointer">
                Get Started
              </div>
            </SignInButton>
        </div>
